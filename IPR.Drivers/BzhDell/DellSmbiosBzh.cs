...
namespace DellFanManagement.DellSmbiozBzhLib
{
    ...
    public class DellSmbiosBzh
    {
        ...
        /// <summary>
        /// Gets the fan level of one of the fans.
        /// </summary>
        /// <param name="fanIndex">Which fan to set the level of.</param>
        /// <param name="fanLevel">Which fan level to set.</param>
        /// <returns>ulong-max means failure.</returns>
        public uint? GetFanLevel(BzhFanIndex fanIndex)
        {
            return ExecuteCommand(SmbiosCommand.GetFanLevel, (uint)fanIndex);
        }
        ...
        public uint? GetFanRpm(BzhFanIndex fanIndex)
        {
        ...
        private bool InstallDriver(string pszDriverPath, bool IsDemandLoaded)
        {
        ...
        public uint? ExecuteCommand(SmbiosCommand command, uint argument = NoParameter)
        {
            if (!IsInitialized)
            {
                return null;
